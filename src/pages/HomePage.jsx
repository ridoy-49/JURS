  ...
  return (
    <>
        ...
        <div className="flex md:flex-row flex-col justify-between items-start px-6 py-5 md:pl-16  md:py-24 gap-2 md:max-w-[1312px] max-[191px]">
          ...
          <div className="flex-1 py-2 md:ml-24 flex flex-col justify-center items-start ">
            <p className="roboto-nav overflow-auto">
              ...
              mentorship, and a platform to share their findings with the world.
            </p>
      ...
      <div className="px-6 md:px-10">
        ...
        {/* no.2 div */}
        <div className="py-64 md:py-28 flex flex-col justify-start items-start">
          ...
          <div className="mb-4">
            ...
            <p className="poppins-bold py-4 text-[48px]">Events</p>
            <p className="font-xs ">
              Fostering innovation, empowering education, and advancing research
          ...
          <div className="flex flex-col py-6">
            <div className="justify-start hidden md:flex flex-row items-start gap-4">
              <button
                className={`px-3 py-2  ${
          faculty === 'View all' ? 'bg-blue-600 text-white' : 'border-2 border-black'
        }`}
              ...
              <button
                className={`px-3 py-2  ${
          faculty === 'Science' ? 'bg-blue-600 text-white' : 'border-2 border-black'
        }`}
              ...
              <button
                className={`px-3 py-2  ${
          faculty === 'Arts' ? 'bg-blue-600 text-white' : 'border-2 border-black'
        }`}
              ...
              <button
                className={`px-3 py-2  ${
          faculty === 'BBA' ? 'bg-blue-500 text-white' : 'border-2 border-black'
        }`}
